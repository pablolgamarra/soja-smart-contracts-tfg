...
export declare namespace ERC2771Forwarder {
    ...
    export type ForwardRequestDataStruct = {from: AddressLike, to: AddressLike, value: BigNumberish, gas: BigNumberish, deadline: BigNumberish, data: BytesLike, signature: BytesLike}

    export type ForwardRequestDataStructOutput = [from: string, to: string, value: bigint, gas: bigint, deadline: bigint, data: string, signature: string] & {from: string, to: string, value: bigint, gas: bigint, deadline: bigint, data: string, signature: string }
...
decodeFunctionResult(functionFragment: 'verify', data: BytesLike): Result;
    ...
    export namespace ExecutedForwardRequestEvent {
      export type InputTuple = [signer: AddressLike, nonce: BigNumberish, success: boolean];
      export type OutputTuple = [signer: string, nonce: bigint, success: boolean];
      export interface OutputObject {signer: string, nonce: bigint, success: boolean };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    executeBatch: TypedContractMethod<
      [requests: ERC2771Forwarder.ForwardRequestDataStruct[], refundReceiver: AddressLike, ],
      [void],
      'payable'
    >
